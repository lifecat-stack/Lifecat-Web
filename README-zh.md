...
> 这是一个 极简的仿Instagram的简易vue项目 它只包含了 Element UI & axios & iconfont & permission control & lint，这些搭建后台必要的东西。

 #### [线上地址](www.lifecat.club/lifecat)
...
## Extra
如果你想要根据用户角色来动态生成侧边栏和router，你可以使用改分支[permission-control](https://github.com/kevinten10/Web-lifecat/tree/permission-control)
...
## 相关项目
  ...
  [Vue后台管理系统Vue-Admin-lifecat](https://github.com/kevinten10/Vue-Admin-lifecat)
...
### Element-Ui 使用cdn教程
首先找到 `index.html` ([根目录下](https://github.com/kevinten10/Web-lifecat/blob/element-ui-cdn/index.html))

引入 Element的css和js ，并且引入 vue 。因为 Element-Ui 是依赖 vue 的，所以必须在它之前引入 vue 。

之后找到 [webpack.base.conf.js](https://github.com/kevinten10/Web-lifecat/blob/element-ui-cdn/build/webpack.base.conf.js) 加入 `externals` 让webpack 不打包 vue 和 element
```
externals: {
  vue: 'Vue',
  'element-ui':'ELEMENT'
...
**[具体代码](https://github.com/kevinten10/Web-lifecat/commit/746aff560932704ae821f82f10b8b2a9681d5177)**

**[对应分支](https://github.com/kevinten10/Web-lifecat/tree/element-ui-cdn)**
