    ...
    s.prototype = {
        version: "5.2.0", _init: function () {
            ...
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                var i, s, o, n, r = t.touches ? t.touches[0] : t, a = r.pageX - this.pointX, l = r.pageY - this.pointY,
                    c = h.getTime();
            ...
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                var i, s, o = (t.changedTouches ? t.changedTouches[0] : t, h.getTime() - this.startTime),
                    n = e.round(this.x), r = e.round(this.y), a = e.abs(n - this.startX), l = e.abs(r - this.startY),
                    c = 0, p = "";
            ...
            var i, e = this.options.interactiveScrollbars, s = "string" != typeof this.options.scrollbars, r = [],
                h = this;
            ...
            this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function () {
                var t, i, s, o, n, r, h = 0, a = 0, l = 0, c = this.options.snapStepX || this.wrapperWidth,
 ...
 */
    function (t, i) {
        var e = "active", s = "." + e, o = "fp-section", n = "." + o, r = n + s, h = "fp-slide", a = "." + h, l = a + s,
            c = "fp-slides", p = "." + c, d = "fp-scrollable", u = "." + d;
    ...
    $.fn.fp_scrolloverflow = function () {
        function e() {
            ...
            function s(i) {
                if (!i.hasClass("fp-noscroll")) {
                    ...
                    var e, s = r.options.scrollOverflowHandler, o = s.wrapContent(), n = i.closest(a),
                        h = s.scrollable(i);
        ...
        var s = "fp-scrollable", o = "." + s, n = "active", r = "." + n, h = "fp-section", a = "." + h, l = a + r,
            c = "fp-slide", p = "." + c, d = p + r, u = "fp-slides", f = "." + u, m = "fp-tableCell", v = "." + m,
            g = "fp-responsive", y = "fp-auto-height-responsive";
        ...
        var S = {
            ...
            create: function (t, i, e) {
                ...
                s.height(i), s.each(function () {
                    var t = $(this), i = t.data("iscrollInstance");
